...
class Complex_Element_Object():
    ...
    def find_node_in_tree(self,name_of_node_in_search: str):
        ...
        if self.complex_data.Name == name_of_node_in_search :
            ...
            listOfTypos = ["Measurement","Series", "Detail","Series",'Acknowledgement','MarketDocument','Volume',"Series",'Reading',"DateAndOrTime","AggregatedAllocation","Series","Allocation","Series","AllocationFactor","Series"]
